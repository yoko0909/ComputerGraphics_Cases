...
BOOL CTestApp::InitInstance()
{
	...
	m_pMainWnd->SetWindowTextW(_T("综合案例6：绘制红绿蓝直线校核图"));
...
//	ON_COMMAND(ID_GRAPH_RUN, &CAboutDlg::OnGraphRun)
//	ON_COMMAND(ID_GRAPH_RUN, &CAboutDlg::OnGraphRun)
//	ON_COMMAND(ID_GRAPH_PAUSE, &CAboutDlg::OnGraphPause)
//	ON_UPDATE_COMMAND_UI(ID_GRAPH_RUN, &CAboutDlg::OnUpdateGraphRun)
//	ON_UPDATE_COMMAND_UI(ID_GRAPH_PAUSE, &CAboutDlg::OnUpdateGraphPause)
END_MESSAGE_MAP()
